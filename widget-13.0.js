(function () {
  ...
  function initWidget() {
    ...
    // Get the script tag using its src attribute instead of document.currentScript
    const scriptTags = document.getElementsByTagName('script');
    let scriptTag = null;

    // Find the correct script tag by checking the src URL for your widget file
    for (let i = 0; i < scriptTags.length; i++) {
      if (scriptTags[i].src.includes('chat-widget-10.0.js')) {
