(function () {
  ...
  function initWidget() {
    console.log('Initializing chat widget...'); // Log to verify initialization
    ...
    console.log('Primary Color:', primaryColor); // Debug primary color
    console.log('Secondary Color:', secondaryColor); // Debug secondary color
    ...
    console.log('Chat bubble added to the DOM'); // Verify chat bubble addition
    ...
    console.log('Chat form container added to the DOM'); // Verify form container
    ...
    chatFormContainer.innerHTML = `
      ...
      <form id="chat-form" style="border: 2px solid; border-image: linear-gradient(to right, ${primaryColor}, ${secondaryColor}) 1; padding: 10px; border-radius: 10px; margin: 15px; text-align: center; display: flex; flex-direction: column; justify-content: center; align-items: center; box-sizing: border-box;">
        ...
        <input type="email" id="email" name="email" placeholder="Your Email" required style="width: 100%; padding: 8px; margin: 8px 0; border: 1px solid #ccc; border-radius: 8px; font-size: 14px; font-family: 'Helvetica', 'Arial', sans-serif; box-sizing: border-box;">
        ...
        <textarea id="message" name="message" placeholder="Your Message or Vehicle Choice" required style="width: 100%; height: 100px; padding: 8px; margin: 8px 0; border: 1px solid #ccc; border-radius: 8px; font-size: 14px; font-family: 'Helvetica', 'Arial', sans-serif;"></textarea>
        <button type="submit" id="submit-btn" style="width: 100%; padding: 8px; margin: 8px 0; background-color: ${primaryColor}; color: white; border: none; border-radius: 8px; cursor: pointer; font-size: 14px; font-family: 'Helvetica', 'Arial', sans-serif; transition: transform 0.3s ease;">Send Message 👉🏼</button>
      </form>
